...
data class UpdateInfo(
    val availableOnline: Boolean = false,
    ...
    fun withAvailableOnline(v: Boolean) = copy(availableOnline = v)
    ...
    fun withFinalizing(v: Boolean) = copy(finalizing = v)
    ...
    class Builder(
        private var availableOnline: Boolean = false,
        ...
        constructor(update: UpdateInfo) : this(
            update.availableOnline, update.downloadId, update.downloadUrl,
            update.eta, update.file, update.fileSize, update.finalizing,
            update.installProgress, update.name, update.progress, update.speed,
            update.status, update.timestamp, update.type, update.version,
        )

        fun setAvailableOnline(v: Boolean) = apply { availableOnline = v }
        ...
        fun setFinalizing(v: Boolean) = apply { finalizing = v }
        ...
        fun build() = UpdateInfo(
            availableOnline, downloadId, downloadUrl, eta, file, fileSize,
            finalizing, installProgress, name, progress, speed, status,
