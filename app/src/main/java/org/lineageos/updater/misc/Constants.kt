...
object Constants {
    ...
    const val NOTIFICATION_ID_EXPORT_UPDATE = 16
    const val NOTIFICATION_ID_INSTALL_ERROR = 0
    const val NOTIFICATION_ID_NEW_UPDATES = 1
    const val NOTIFICATION_ID_ONGOING = 10
    const val NOTIFICATION_ID_POST_INSTALL = 11
    const val NOTIFICATION_CHANNEL_EXPORT_UPDATE = "notification_channel_export_update"
    const val NOTIFICATION_CHANNEL_INSTALL_ERROR = "notification_channel_install_error"
    ...
    const val NOTIFICATION_CHANNEL_POST_INSTALL = "notification_channel_post_install"
    ...
    const val PROP_ALLOW_MAJOR_UPGRADES = "lineage.updater.allow_major_upgrades"
