...
import org.lineageos.updater.data.UpdaterDbRepository;
import org.lineageos.updater.data.source.local.UpdaterDatabase;
...
public class UpdaterController {
    ...
    private UpdaterController(Context context) {
        ...
        mUpdatesRepository = new UpdaterDbRepository(UpdaterDatabase.getInstance(context).updateDao());
        ...
        new Thread(() -> {
            ...
            for (Update update : mUpdatesRepository.getUpdates()) {
